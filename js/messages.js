...
const Messages = {
  ...
  conversations: [
    {
      id: 1, name: 'Alex Morgan', avatar: 'images/user1.jpg', online: true,
      lastMsg: 'That design looks incredible! 🔥', time: '2m', unread: 3,
      messages: [
        { from: 'them', text: 'Hey! Did you see the new design system I shipped?', time: '10:30 AM' },
        { from: 'me',   text: 'Yes! It looks absolutely amazing 🔥', time: '10:32 AM', read: true },
        { from: 'them', text: 'Thanks! I spent 3 months on it 😅', time: '10:33 AM' },
        { from: 'me',   text: 'The color palette is just perfect', time: '10:35 AM', read: true },
        { from: 'them', text: 'That design looks incredible! 🔥', time: '10:36 AM' },
      ]
    },
    {
      id: 2, name: 'Sarah Chen', avatar: 'images/user2.jpg', online: true,
      lastMsg: 'Can we schedule a call tomorrow?', time: '1h', unread: 1,
      messages: [
        { from: 'them', text: 'Hi! Working on that AWS project?', time: '9:00 AM' },
        { from: 'me',   text: 'Yes, just finished the EC2 setup', time: '9:05 AM', read: true },
        { from: 'them', text: 'Can we schedule a call tomorrow?', time: '9:10 AM' },
      ]
    },
    {
      id: 3, name: 'David Kim', avatar: 'images/user3.jpg', online: false,
      lastMsg: 'See you at the conference!', time: '3h', unread: 0,
      messages: [
        { from: 'me',   text: 'Are you going to TechConf 2026?', time: 'Yesterday' },
        { from: 'them', text: 'Absolutely! It\'s going to be epic', time: 'Yesterday', read: true },
        { from: 'them', text: 'See you at the conference!', time: 'Yesterday' },
      ]
    },
    {
      id: 4, name: 'Maria Lopez', avatar: 'images/user1.jpg', online: false,
      lastMsg: 'Thanks for sharing the article!', time: '1d', unread: 0,
      messages: [
        { from: 'them', text: 'I read your article on AI trends', time: 'Mon' },
        { from: 'me',   text: 'Glad you liked it!', time: 'Mon', read: true },
        { from: 'them', text: 'Thanks for sharing the article!', time: 'Mon' },
      ]
    },
  ],
  ...
  updateBadge() {
    const badge = document.querySelector('[data-section="messages"] .nav-badge');
    if (!badge) return;
  ...
  sendMessage() {
    ...
    const msg = { from: 'me', text, time: new Date().toLocaleTimeString([], {hour:'2-digit', minute:'2-digit'}), read: false };
  ...
  showEmptyChat() {
    ...
    win.innerHTML = `
      <div class="chat-empty">
        ...
        <button class="btn btn-primary" style="margin-top:var(--space-lg);padding:10px 24px;height:auto;" onclick="App.showToast('New message feature coming soon!','info')">
  ...
  callAction(type) {
    App.showToast(`${type === 'video' ? 'Video' : 'Voice'} call coming soon! 📞`, 'info');
  }
};
