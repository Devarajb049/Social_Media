...
const Profile = {
  ...
  renderProfile() {
    ...
    setEl('profile-headline',     user.role || 'Software Developer · Open to opportunities');
    setEl('profile-bio',          user.bio || 'Passionate builder, creative thinker, and lifelong learner. Building the future one line of code at a time. 🚀');
    ...
    // Skills
    const skills = ['JavaScript', 'React', 'Node.js', 'Python', 'TypeScript', 'AWS', 'GraphQL', 'Docker', 'Figma', 'SQL'];
    ...
    setHtml('profile-meta', `
      ...
      <div class="profile-meta-item"><i class="fas fa-link"></i> <a href="#" style="color:var(--color-primary);">portfolio.dev</a></div>
      <div class="profile-meta-item"><i class="fas fa-calendar-alt"></i> Joined January 2023</div>
    `);
  },
  ...
  renderPostGrid() {
    ...
    const posts = [
      { img: 'images/post1.jpg', likes: 248, comments: 34 },
      { img: 'images/post2.jpg', likes: 189, comments: 22 },
      { img: 'images/post3.jpg', likes: 512, comments: 67 },
  ...
  renderShowcase() {
    ...
    const projects = [
      ...
      },
      {
        ...
        desc: 'A modern analytics dashboard with ML-powered insights and beautiful data visualizations.',
        img: 'images/post2.jpg',
        tags: ['TypeScript', 'D3.js', 'Python']
      },
      {
        title: 'E-Commerce App',
        desc: 'Scalable e-commerce solution with payment integration and real-time inventory management.',
        img: 'images/post3.jpg',
        tags: ['Next.js', 'Stripe', 'PostgreSQL']
      },
      {
        title: 'Mobile Fitness App',
        desc: 'Cross-platform fitness tracker with AI-powered workout recommendations.',
        img: 'images/post1.jpg',
      ...
      <div class="showcase-card" role="article" aria-label="${p.title}">
        ...
        <div class="showcase-card-body">
          ...
          <div style="display:flex;gap:var(--space-sm);margin-top:var(--space-md);">
            ...
            <button class="btn btn-sm btn-outline" onclick="App.showToast('Opening GitHub...','info')">
  ...
  renderExperience() {
    ...
    const items = [
      { icon: 'fa-building', title: 'Senior Frontend Developer', company: 'TechCorp Inc.', period: 'Jan 2024 – Present · 1 yr 5 mos' },
      { icon: 'fa-laptop-code', title: 'Full Stack Developer', company: 'StartupXYZ', period: 'Mar 2022 – Dec 2023 · 1 yr 9 mos' },
      { icon: 'fa-graduation-cap', title: 'B.S. Computer Science', company: 'MIT', period: '2018 – 2022' },
    ];
